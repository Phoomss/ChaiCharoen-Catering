    ...
    try {
      if (currentPackage) {
        ...
        Swal.fire({
          ...
          text: `ชุด套餐 ได้ถูกเพิ่มเรียบร้อยแล้ว`,
          confirmButtonColor: '#22c55e'
        });
      }
      ...
      Swal.fire({
        ...
        text: err.response?.data?.message || 'ไม่สามารถบันทึกชุด套餐ได้ กรุณาลองอีกครั้ง',
  ...
  const deleteMenuPackage = async (pkg) => {
    ...
    if (result.isConfirmed) {
      try {
        Swal.fire({
          title: 'กำลังลบ...',
          text: 'กรุณารอสักครู่ในขณะที่เรากำลังลบชุด套餐',
        ...
        Swal.fire({
          icon: 'error',
          title: 'การลบล้มเหลว',
          text: err.response?.data?.message || 'ไม่สามารถลบชุด套餐ได้ กรุณาลองอีกครั้ง',
          confirmButtonColor: '#dc2626'
        });
      }
    }
